...
class AnnouncementModel extends CI_Model {
    ...
    function GetAnnouncementList($id=0){
        ...
        (
                ...
                SELECT
                        ...
                        a.posted_date,GROUP_CONCAT(d.department_title)as DepartmentList,
                ...
                FROM announcements as a
                        ...
                        LEFT JOIN employees as b ON a.post_by_user_id=b.user_account_id
