...
<head>
    ...
    <title> Infoboard | User Role Management </title>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 animated fadeInRight">
                    <div class="mail-box-header" style="margin-bottom:-25px;">
                        <h2 style="block:inline;"><i class="fa fa-users"></i> User Group Management </h2>
                        ...
                        <div class="panel-heading">
                            <div class="panel-options">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#tab-1">List of Users Group</a></li>
                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    <div class="table-responsive">
                                        <table id="tbl_user_role_list" class="table table-bordered table-striped ">
                                        <thead>
                                        <tr>
                                            <td></td>
                                            <td>Users Group</td>
...
<!---/consumer modal--->
<div class="modal fade" id="user_role_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog"  style="width:50%;">
        <div class="modal-content animated bounceInRight">
                        ...
                        <div class="panel panel-default" style="margin-bottom:-20px;border-radius:0px;">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>User Group Management<small class="m-l-sm">Please enter User Group Information.</small></h5>
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        <form id="frm_user_role_info">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label>User Group</label>
                                                    <input class="form-control" type="text" name="user_group_title" id="user_group_title" placeholder="User Group"  data-container="body" data-trigger="manual" data-toggle="tooltip" title="User Group is required."data-message="Please make sure you enter User Group." required >
                                                </div>

                                                <div class="form-group">
                                                    <label>Description</label>
                                                     <textarea name="user_group_desc" id="user_group_desc" class="form-control" rows="5">
            ...
            <div class="modal-footer">
                <button id="btn_create_user_role" type="button" class="btn btn-primary"><i class="fa fa-save"></i> <u>R</u>ecord User Group </button>
...
<!--Custom JS-->
<script src="assets/js/defined/user.group.management.event.handlers.js"></script>
