...
<head>
    ...
    <title> Infoboard | Course Management </title>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 animated fadeInRight">
                    <div class="mail-box-header" style="margin-bottom:-25px;">
                        <h2 style="block:inline;"><i class="fa fa-users"></i> Course  Management </h2>
                        ...
                        <div class="panel-heading">
                            <div class="panel-options">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#tab-1">List of Course</a></li>
                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    <div class="table-responsive">
                                        <table id="tbl_info_list" class="table table-bordered ">
                                        <thead>
                                        <tr>
                                            <td></td>
                                            <td>Department</td>
    ...
    <div class="modal-dialog"  style="width:50%;">
        <div class="modal-content animated bounceInRight">
                        ...
                        <div class="panel panel-default" style="margin-bottom:-20px;border-radius:0px;">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Course Management<small class="m-l-sm">Please enter Course Information.</small></h5>
                                        ...
                                        <form id="frm_info">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="course_title" id="course_title" placeholder="Course Title"  data-container="body" data-trigger="manual" data-toggle="tooltip" title="Course Title is required."data-message="Please make sure you enter Course Title." required >
                                                </div>

                                                <div class="form-group">
                                                    <label>Course Code * </label>
                                                    <input class="form-control" type="text" name="course_code" id="course_code" placeholder="Course Code"  data-container="body" data-trigger="manual" data-toggle="tooltip" title="Course Code is required."data-message="Please make sure you enter Course Code." required >
                                                </div>

                                                <div class="form-group">
                                                    <label>Description</label>
                                                     <textarea style="margin-bottom: 0px" name="course_desc" id="course_desc" class="form-control summernote" >
                                                     </textarea>
                                                ...
                                                <div class="form-group">
                                                    <label>Department</label>
                                                     <select style="margin-bottom: 0px" name="department_id" id="department_id" class="form-control " >
                                                     </select>
            ...
            <div class="modal-footer">
                <button id="btn_create_info" type="button" class="btn btn-primary"><i class="fa fa-save"></i> <u>R</u>ecord Course </button>
...
<!--Custom JS-->
<script src="assets/js/defined/course.management.event.handlers.js"></script>
