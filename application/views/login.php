...
<body id="page-top"   aclss="" style="background-color: #ffffff">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="index-2.html">INFOBOARD</a>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="ibox-content">
                   <!--for CI Built- In Form Validation and Login Authentication
                   I've Create my Own Ajax Login Process -->
                 ...
                 <form id="frm-login">  
                     <div class="form-group"> 
                        <input class="form-control" type="text" name="username" id="username" placeholder="Username"  data-container="body" data-trigger="manual" data-toggle="tooltip" title="Username"data-message="Please make sure you Username." required >
                    </div>
                <div class="form-group">
                     <input class="form-control" type="password" name="password" id="password" placeholder="Password"  data-container="body" data-trigger="manual" data-toggle="tooltip" title="password" data-message="Please make sure you Password." required >
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="assets/img/avatar2.jpg" class="img-responsive img-circle img-small" alt="">
